...
public class PostBuyFormItemDealsStruct  implements java.io.Serializable {
    ...
    private SandboxWebApi.PostBuyFormItemDealsVariantStruct dealVariant;
    ...
    public PostBuyFormItemDealsStruct(
           ...
           SandboxWebApi.PostBuyFormItemDealsVariantStruct dealVariant) {
           this.dealId = dealId;
     ...
     * @return dealVariant
     */
    public SandboxWebApi.PostBuyFormItemDealsVariantStruct getDealVariant() {
        return dealVariant;
    }
     ...
     * @param dealVariant
     */
    public void setDealVariant(SandboxWebApi.PostBuyFormItemDealsVariantStruct dealVariant) {
        this.dealVariant = dealVariant;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:SandboxWebApi", "dealVariant"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:SandboxWebApi", "PostBuyFormItemDealsVariantStruct"));
